...
module.exports = clap.create('build', '[file]')
  ...
  .init(function(){
    if (this.config)
      applyConfig(this, this.config[this.name] || {}, this.configPath);
  })
  ...
  //.option('-r, --js-resolve-path', '(experimental) Resolve local paths to globals and replace for global references')
