...
module.exports = function(flow){
  ...
  fconsole.log('[i] include basis.js modules for template parsing');
  ...
  // apply collected
  fconsole.start('[i] apply template defines');
  for (var themeName in flow.js.themes)
  {
    fconsole.start('theme `' + themeName + '`');
    for (var key in flow.js.themeResources[themeName])
    {
      var resource = flow.js.themeResources[themeName][key];
