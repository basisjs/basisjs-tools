...
(module.exports = function(flow){
  ...
  {
    //
    // process l10n keys pathes
    //
    fconsole.start('Fix l10n keys in templates');
    flow.l10n.tmplRefs.forEach(function(entry){
      ...
      entry.host[entry.idx] = 'l10n:' + entry.name + '@' + entry.dictionary.file.jsRef;
    ...
    //
    fconsole.start('Change basis.l10n.dictionary');
