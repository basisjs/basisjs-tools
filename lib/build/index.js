  ...
  function finalHandler(){
    ...
    (function(){
      ...
      flow.files.queue.forEach(function(file){
        ...
        {
          outputFileCount++;
          outputSize += file.outputContent.length;
          stat.outputSize += file.outputContent.length;
          stat.outputFiles.push(file.outputFilename + ' ' + file.outputContent.length + ' bytes');
        }
      }, fileTypeMap);
