...
var k = 0;
  for (var i = 0, file; file = queue[i]; i++)
    ...
    {
      processFile(fconsole, file, refs, exportMap, flow.js.globalScope, exports);
      // if (++k == 6 )
      // {
...
var throwIdx = 0;
function processFile(fconsole, file, refs, exportMap, globalScope, exports){
  fconsole.start(file.relpath);

  //var res = at.processPath(file.ast, rootNames, refs, exportMap, namespace, globalScope);
