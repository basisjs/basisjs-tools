...
module.exports = function(flow){
  ...
  // flow.js.classes.forEach(function(cls){
  //   if (cls.obj.className[0] == 'binary')
  //     console.log(cls.obj.className[3][1], !!cls.ref_.refs_);
  //   else
  //     console.log(cls.obj.className, !!cls.ref_.refs_);
  //   //console.log(cls);
  // });
