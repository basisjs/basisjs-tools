...
module.exports = function(flow){
  ...
  var pathMap = {};
   ...
   // console.log(require('util').inspect(at.parse('exports = { a:  new A }; function a(b){ function a2(){} g1 = 123; return 1 }'), null, 12 ));
   // process.exit();
...
var localIdx = 0;
function processFile(file, flow, pathMap){
  var fconsole = flow.console;
  ...
  function localName(name){
    ...
    if (name == 'axis') console.log(token.rename, token.token);
    return token.rename;
    ...
    '*': function(token){
      ...
      switch (token[0])
      {
        ...
        case 'name':
          ...
          if (name != 'this' && scope && scope.level >= file.jsScope.level)
