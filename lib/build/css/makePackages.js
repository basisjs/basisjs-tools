...
module.exports = function(flow){
    ...
    if (file.type == 'style' && file.isResource)
    {
      ...
      else
      {
        file.themes.forEach(function(themeName){
          hasCustomThemes = hasCustomThemes || themeName != 'base';
  ...
  if (!hasCustomThemes && styleFileMap['theme-base'])
  {
    styleFileMap['theme-base'].forEach(function(file){
      putStyle('style', file);
    });
    delete styleFileMap['theme-base'];
  }
