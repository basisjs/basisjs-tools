...
module.exports = function(flow){
  ...
  // var ast = at.parse('function ss(){};var a = { x: function xx(a){} }');
  // console.log(require('util').inspect(ast, { showHidden: true, depth: null, colors: true }));
  // at.applyScope(ast, new at.Scope());
