...
module.exports = function(flow){
  ...
  [
    ...
    globalScope.put(name, '?', ['function', null, [], []]);
  });
  ...
  globalScope.put('importScripts', '?', at.createRunner(function(token_, this_, args){
...
function processFile(file, flow){
  ...
  //   if (!token.scope.has(token[1]))
  //     console.log(file.filename, token[1]);
  // });
