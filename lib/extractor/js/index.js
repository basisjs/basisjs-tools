...
function processFile(file, flow){
  ...
  {
    file.ast[1] = [['function', null, ['exports', 'module', 'basis', 'global', '__filename', '__dirname', 'require', 'resource'],
      file.ast[1]
    ]];
    ...
    var handlers = {
      ...
      requireNamespace: function(token, this_, args){
        ...
        else
        {
          ...
          var filename = path.resolve(flow.options.file, arg1, arg0); // TODO: resolve filename relative to html file
          var file = this.file;
