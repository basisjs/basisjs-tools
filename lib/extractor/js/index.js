  ...
  if (file.type == 'script' && !file.jsScope)
  {
    ...
    var names = {
      ...
      resource: at.createRunner(function(token, this_, args){
        ...
        token[2] = [args[0] = ['binary', '+', ['string', file.baseURI], args[0]]];
    ...
    if (!flow.js.oldBasis)
    {
      ...
      names.require = at.createRunner(function(token, this_, args){
        ...
        token[2] = [args[0], args[1] || (args[1] = names.__dirname.slice(0))];
...
function processFile(file, flow){
  ...
  {
    file.ast[1] = [['function', null, ['exports', 'module', 'basis', 'global', '__filename', '__dirname'],
      file.ast[1]
    ]];
