;(function(global, console){
  ...
  */
  ...
  global.basisjsToolsFileSync = {
    ...
    getBundle: function(indexFilename, callback){
  ...
  (function(){
    ...
    function sendInfo(){
      ...
      if (clientInfo.title != newClientInfo.title ||
        ...
        sendToServerOnline('devtool:info', getSelfInfo());
      }
    }
    ...
    overlay.innerHTML = '<div style="font-size: 33vmax">2</div><button style="font-size:18px;padding:8px">Start inspect</button>';
    ...
    basisjsToolsFileSync.initDevtool = function(){
      clientInfo = getSelfInfo();
      sendToServerOnline('devtool:handshake', clientInfo);
      clearInterval(sendInfoTimer);
