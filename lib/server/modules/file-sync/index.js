...
module.exports = function initFileSync(wsServer, httpServer, options){
  ...
  wsServer.addCommand('file:read', require('./command/readFile')(options));
  wsServer.addCommand('file:save', require('./command/saveFile')(options));
  wsServer.addCommand('file:create', require('./command/createFile')(options));
