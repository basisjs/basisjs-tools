...
function createWsServer(httpServer){
  ...
  httpServer.addVirtualPath('/basisjs-tools/devtool', path.join(__dirname, 'assets/devtool.html'));
  httpServer.addVirtualPath('/basisjs-tools/devtool.js', path.join(__dirname, 'assets/devtool.js'));
