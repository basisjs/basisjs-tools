    ...
    if (virtualPath.has(relFilename))
      return virtualPath.get(relFilename)({
        ...
        logMsg: function(message){
          console.warn('httpApi.logMsg is deprecated, use httpApi.log instead');
          return logMsg('client', relFilename + ' ' + message);
        },
        logWarn: function(message){
          console.warn('httpApi.logWarn is deprecated, use httpApi.warn instead');
          return logWarn('client', relFilename + ' ' + message);
        },
        log: function(message, verboseOnly){
          return logMsg('client', relFilename + ' ' + message, verboseOnly);
        },
