...
api.initRemoteDevtoolAPI = function(getRemoteUI){
  var subscribers = [];

  // for legacy reason
  if (getRemoteUI && getRemoteUI.getInspectorUI)
    getRemoteUI = getRemoteUI.getInspectorUI;

  socket
    .on('devtool:get ui', getRemoteUI)
  ...
  return {
    connected: api.remoteInspectors,
...
api.initRemoteObserver = (function(){
  var observersMap = {};
  ...
  return function(id, getRemoteUI){
    var subscribers = [];
