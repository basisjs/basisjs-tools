    ...
    socket.on('devtool:client connect', function(data, connectCallback){
      ...
      this
        ...
        .on('devtool:session data', function(){
          ...
          channel.emit.apply(channel, ['devtool:session data'].concat(Array.prototype.slice.call(arguments)));
        })
    ...
    socket.on('devtool:join session', function(clientId, callback){
      ...
      this
        ...
        .on('devtool:session command', function(){
          client.emit.apply(client, ['devtool:session command'].concat(Array.prototype.slice.call(arguments)));
        })
        .on('disconnect', function(){
